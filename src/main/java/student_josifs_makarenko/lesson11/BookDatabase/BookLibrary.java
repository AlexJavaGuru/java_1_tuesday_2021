...
import student_josifs_makarenko.lesson11.BookDatabase.UIAction.*;
...
public class BookLibrary {
    ...
    public BookLibrary() {
        ...
        menuNumberToActionMap.put(6, new CountAllBooksUIActon(bookDatabase));
        ...
        menuNumberToActionMap.put(14, new FindUIAction(bookDatabase));
    }
