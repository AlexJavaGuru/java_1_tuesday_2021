...
public class ArrayDemo {
    public static void main(String[] args) {
        ...
        int[] myThirdArray;
        myThirdArray = array.createArray(3);
        ...
        System.out.println("This array that increased for 2: " + Arrays.toString(myThirdArray));
    }
}
