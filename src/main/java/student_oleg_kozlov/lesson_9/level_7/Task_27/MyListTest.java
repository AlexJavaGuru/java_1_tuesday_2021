...
class MyListTest {
    ...
    public static void main(String[] args) {
        ...
        shouldGetElementByIndexTestFirstElement();
        shouldGetElementByIndexTestLastElement();
        shouldGetElementByIndexTestBeforeListMiddle();
        shouldGetElementByIndexTestAfterListMiddle();
        shouldAddItemsToListTest();
        shouldAddItemsToListByIndexTestFirstItem();
        ...
        shouldRemoveItemFromListByIndexTestFirstItem();
        shouldRemoveItemFromListByIndexTest();
        shouldRemoveItemFromListByIndexTestLastItem();
        shouldClearListTest();
    ...
    private static void shouldGetElementByIndexTestFirstElement() {
        totalRun++;
        MyListImpl list = new MyListImpl();
        list.add(new MyClass(1));
        list.add(new MyClass(3));
        list.add(new MyClass(5));
        checkResult(new MyClass(1),  list.get(0),"shouldGetElementByIndexTestFirstElement");
    }

    private static void shouldGetElementByIndexTestLastElement() {
        totalRun++;
        MyListImpl list = new MyListImpl();
        list.add(new MyClass(1));
        list.add(new MyClass(3));
        list.add(new MyClass(5));
        checkResult(new MyClass(5),  list.get(2),"shouldGetElementByIndexTestLastElement");
    }

    private static void shouldGetElementByIndexTestBeforeListMiddle() {
        totalRun++;
        MyListImpl list = new MyListImpl();
        list.add(new MyClass(1));
        list.add(new MyClass(3));
        ...
        checkResult(new MyClass(3),  list.get(1),"shouldGetElementByIndexTestBeforeListMiddle");
    }

    private static void shouldGetElementByIndexTestAfterListMiddle() {
        totalRun++;
        MyListImpl list = new MyListImpl();
        list.add(new MyClass(1));
        list.add(new MyClass(3));
        ...
        list.add(new MyClass(7));
        list.add(new MyClass(9));
        checkResult(new MyClass(7), list.get(3),"shouldGetElementByIndexTestAfterListMiddle");
    }
    ...
    private static void shouldAddItemsToListTest() {
        ...
        list.add(new MyClass(1));
        list.add(new MyClass(2));
        checkResult(2,  list.size(),"shouldAddItemsToListTest");
    }

    private static void shouldAddItemsToListByIndexTestFirstItem() {
        totalRun++;
        MyListImpl list = new MyListImpl();
        list.add(new MyClass(2));
        list.add(new MyClass(3));
        list.add(new MyClass(4));
        list.add(0, new MyClass(1));
        ...
        checkResult(expected, list,"shouldAddItemsToListByIndexTestFirstItem");
    }
    ...
    private static void shouldRemoveItemFromListByIndexTestFirstItem() {
        totalRun++;
        MyListImpl list = new MyListImpl();
        list.add(new MyClass(1));
        list.add(new MyClass(2));
        ...
        expected.add(new MyClass(2));
        expected.add(new MyClass(3));
        checkResult(expected,  list,"shouldRemoveItemFromListByIndexTestFirstItem");
    }
    ...
    private static void shouldRemoveItemFromListByIndexTestLastItem() {
        totalRun++;
        MyListImpl list = new MyListImpl();
        list.add(new MyClass(1));
        list.add(new MyClass(2));
        ...
        expected.add(new MyClass(1));
        expected.add(new MyClass(2));
        checkResult(expected,  list,"shouldRemoveItemFromListByIndexTestLastItem");
    }
